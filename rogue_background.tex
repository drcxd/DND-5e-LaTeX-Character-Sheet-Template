...
\textbf{能力值提升(Ability Score Improvement)。}你的敏捷增加到18，并带来如下影响：
\begin{itemize}
\item 你的敏捷修正值变为+4.
\item 你的敏捷攻击，例如使用短剑或短弓，的加成和造成的伤害增加1.
\item 你的敏捷豁免修正值加1.
\item 你的敏捷技能修正值加1.
...
\textbf{诡异闪避(Uncanny Dodge)。}当一个你可以看到的攻击者使用攻击掷骰攻击你时，你可以使用你的反应来减半其对你造成的伤害。
