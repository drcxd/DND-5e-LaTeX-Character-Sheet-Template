...
你的父母生活在繁荣的乡村 Thundertree, 它位于 Neverwinter 的东部， Neverwinter Wood 的边缘。但是附近的 Mount Hotenow 在30年前爆发了，你的父母带着襁褓中的你逃离了那里。你的家人从一个村落流落到另一个村落，做着他们能找到的苦力活。

过去的几年里，你在 Neverwinter 的码头上做力工。但是，你和你周围的人都清楚，你注定要做更大的事。你曾经站出来反抗一个暴虐的船长，所以其它码头工人们都对你另眼相看。总有一天，你会发挥你的潜力。你会成为一个英雄。

\textbf{个人目标：赶走巨龙。} Thundertree 的废墟在召唤你。你的家人和朋友曾在那里安居乐业，但现在他们做着低贱的活计。废墟里游荡着灰烬丧尸，并且有传言说一头龙把 Old Tower 当作它的巢穴，但这些都是一个英雄能够解决的问题。杀掉那头龙，或者赶走它，你会向你自己和所有其他人证明，你是一个真正的英雄，注定要成就一番伟业。

\textbf{阵营：守序善良。}英雄挺身而出，对抗邪恶。英雄为法律和秩序而战，从而使每个人都可以安居乐业。英雄屠杀怪兽，清理废墟，并保护无辜者。你努力成为这样一个英雄。
...
\item 你基于 Dexterity 的攻击，例如使用长弓，的加成和造成的伤害增加1.
\item 你的 Dexterity 豁免修正值加1.
\item 你基于 Dexterity 的技能的修正值增加1.
\item 当你穿着轻甲或没穿护甲时，你的护甲等级增加1.
\item 你的先攻增加1.
\end{itemize}
